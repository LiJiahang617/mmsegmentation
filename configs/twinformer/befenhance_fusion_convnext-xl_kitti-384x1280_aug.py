...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', by_epoch=True, interval=30,
        save_best='mIoU'),
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project="TwinFormer_kitti-384x1280_aug", name="befenhance_fusion_convnext-xl")),
]
visualizer = dict(
