_base_ = [
'../_base_/datasets/mmcityscapes_road_1024x512.py'
]
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="TwinFormer_cityroad-512x1024", name="befenhance_fusion_convnext-b")),
]
visualizer = dict(
