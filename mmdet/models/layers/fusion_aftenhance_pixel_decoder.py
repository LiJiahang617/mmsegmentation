...
class FeatureEnhanceModule(BaseModule):
    """Feature Enhance Module (FEM) after"""
...
class TwinFuseAfterEnhancePixelDecoder(BaseModule):
    ...
    def __init__(self,
        ...
        for i in range(self.num_input_levels):
            enhance_block = FeatureEnhanceModule(in_channels[i], in_channels[i], norm=norm_cfg)
