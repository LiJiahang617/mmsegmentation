...
# feature enhanced with residential connection after feature selection conv
...
@MODELS.register_module()
class TwinAEnhancedPixelDecoder(BaseModule):
    ...
    def __init__(self,
        ...
        for i in range(self.num_input_levels):
            enhance_block = FeatureSelectionModule(in_channels[i], in_channels[i], norm=norm_cfg)
