...
try:
    from mmdet.models.dense_heads import \
        TwinFormerHeadv2 as MMDET_TwinFormerHeadv2
except ModuleNotFoundError:
    MMDET_TwinFormerHead = BaseModule
...
class TwinFormerHeadv2(MMDET_TwinFormerHeadv2):
    """Implements the TwinFormer head with transformer channel attention.
